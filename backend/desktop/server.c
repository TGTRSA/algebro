...
enum MHD_Result handle_req(void *cls, struct MHD_Connection *connection,const char *url, const char *method, const char *version,
...
int main(){
    ...
    struct MHD_Daemon *daemon = MHD_start_daemon(
        ...
        PORT,NULL,NULL, 
        &handle_req, NULL,MHD_OPTION_END
    );
    if(!daemon){
